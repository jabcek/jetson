...
net=jetson.inference.imageNet('googlenet',['--model=/home/jure/Downloads/jetson-inference/python/training/classification/myModelJure/resnet18.onnx','--input_blob=input_0','--output_blob=output_0','--labels=/home/jure/Downloads/jetson-inference/myTrainJure/labels.txt'])
